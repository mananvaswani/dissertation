...
n1, times1, perms1 = np.loadtxt('timings/threadCurve/gcc_threadTest_parallel.csv', delimiter=',', unpack=True)
n2, times2, perms1 = np.loadtxt('timings/threadCurve/intel_threadsTest_parallel.csv', delimiter=',', unpack=True)
...
# ax.errorbar(n, meanTimesList2, yerr=stdDevList2, label = "gcc: time spent in computing pemanents", linestyle='-')
# ax.errorbar(n, meanTimesList1, yerr=stdDevList1, label = "intel: total time taken", linestyle='-')
# ax.errorbar(n, meanTimesList2, yerr=stdDevList2, label = "intel: time spent in computing pemanents", linestyle='-')
ax.plot(n, meanTimesList1, label="g++ compiler")
